...
export const validateAttribute = (attribute, attributes, customCheckBool) => {
    const error = {};
    if(customCheckBool){
        ...
        if (isEmpty(attribute.name1)) {
            error.name = 'Please specify the custom attribute name1'
        }
        if (isEmpty(attribute.operator1)) {
            error.name = 'Please specify the custom attribute operator1'
        }
        if (isEmpty(attribute.name2)) {
            error.name = 'Please specify the custom attribute name2'
        }
